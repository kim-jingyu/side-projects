...
<body data-spy="scroll" data-target="#myScrollspy" data-offset="1">
	...
	<DIV style="position:relative; left:270; top:180; padding:70px 30px 10px 80px; font-size:22px; font-weight:bold;">검색결과</div>
	<%
			...
			<%
				...
				String id= request.getParameter("search");
					for(int i=0;i<listOfcorps.size();i++){
						...
						if(corp.getCname().toLowerCase().indexOf(id.toLowerCase()) > -1){		
			%>
