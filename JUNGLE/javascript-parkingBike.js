...
function get_station_name(n) {
    for (let i = 0; i < bikes.length; i++) {
        let parking_bike_cnt = bikes[i]["parkingBikeTotCnt"]

        if (parking_bike_cnt <= n) {
            let station_name = bikes[i]["stationName"]
            console.log(n + "대 이하 정류장 :" + station_name)
        }
    }
}
